...
public partial class @MenuActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IKeyActionsActions> m_KeyActionsActionsCallbackInterfaces = new List<IKeyActionsActions>();
    ...
    public struct KeyActionsActions
    {
        ...
        public void AddCallbacks(IKeyActionsActions instance)
        {
            if (instance == null || m_Wrapper.m_KeyActionsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_KeyActionsActionsCallbackInterfaces.Add(instance);
            @Escape.started += instance.OnEscape;
            @Escape.performed += instance.OnEscape;
            @Escape.canceled += instance.OnEscape;
        }

        private void UnregisterCallbacks(IKeyActionsActions instance)
        {
            @Escape.started -= instance.OnEscape;
            @Escape.performed -= instance.OnEscape;
            @Escape.canceled -= instance.OnEscape;
        ...
        public void RemoveCallbacks(IKeyActionsActions instance)
        {
            if (m_Wrapper.m_KeyActionsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IKeyActionsActions instance)
        {
            foreach (var item in m_Wrapper.m_KeyActionsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_KeyActionsActionsCallbackInterfaces.Clear();
