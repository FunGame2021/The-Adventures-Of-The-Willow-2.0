...
public class AudioManager : MonoBehaviour
{
    ...
    //evit crete multiple instances
    private bool MusicPlaying = false;
    private bool MenuMusicPlaying = false;
    private bool BossMusicPlaying = false;
    //snapshot instances
    public static class SnapshotReferences
    {
        public static EventInstance NormalSnapshot;
        public static EventInstance CaveSnapshot;
        public static EventInstance UnderwaterSnapshot;
    }
    public static void InitializeSnapshots()
    {
        SnapshotReferences.NormalSnapshot = FMODUnity.RuntimeManager.CreateInstance("snapshot:/Normal");
        SnapshotReferences.CaveSnapshot = FMODUnity.RuntimeManager.CreateInstance("snapshot:/Cave");
        SnapshotReferences.UnderwaterSnapshot = FMODUnity.RuntimeManager.CreateInstance("snapshot:/Underwater");
    }
    ...
    private void Start()
    {
        ...
        // Cria as instâncias dos snapshots
        InitializeSnapshots();
    }
    ...
    {
        menuMusicEventInstance.setParameterByName("MusicMenuChange", (float)MenuMusicChange);
    }
    ...
    //oneshot normal
    public void PlayOneShotNo3D(EventReference sound)
    {
