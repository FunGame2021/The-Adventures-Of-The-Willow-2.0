...
public class CaptainMushroomRed : MonoBehaviour
{
    ...
    [SerializeField] private LayerMask groundLayer; // Configure no Inspector para incluir a layer do ch�o.
    [SerializeField] private float overlapRadius = 0.2f; // Raio de sobreposi��o para verificar colis�es.
    ...
    [SerializeField] private LayerMask colliderObjectsLayer; // Configure no Inspector para incluir a layer do ch�o.
    ...
    private void Update()
    {
        ...
        // Verificar se o ponto central do jogador est� dentro de algum colisor de ch�o
    ...
    bool IsInsideGround()
    {
        // Verificar se h� algum colisor de ch�o dentro do raio de sobreposi��o
    ...
    private void OnDrawGizmos()
    {
        ...
        // Desenhar uma esfera gizmo para representar a �rea de sobreposi��o
        Gizmos.color = Color.red;
        Gizmos.DrawWireSphere(transform.position, overlapRadius);

        // Desenhar as linhas de verifica��o para objetos � esquerda e � direita
        Gizmos.color = Color.red;
